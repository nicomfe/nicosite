...
(function() {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			'global': { range: '*', href: 'styles/style.css', viewport: { scalable: false } },
			'wide': { range: '-1680', href: 'styles/style-wide.css' },
			'normal': { range: '-1280', href: 'styles/style-normal.css' },
			'mobile': { range: '-736', href: 'styles/style-mobile.css' },
			'mobilep': { range: '-480', href: 'styles/style-mobilep.css' }
		}
	});
